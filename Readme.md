...
*ООО «Ракета», Лига А* (удаленная работа)  
Должность: Frontend-разработчик  
Обязанности: Адаптивная, кроссбраузерная верстка макетов сайтов (как новых, так и доработка существующих). Верстка отдельных страниц сайтов, на основе существующих шаблонов и технического задания заказчика. Рефакторинг существующего кода. Работа с общепринятыми в команде практиками: code style и сode review. Взаимодействие с другими разработчиками и менеджерами проектов.
